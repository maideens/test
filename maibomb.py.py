...
while 1:
    ...
    """.format(Fore.RED, len(servisler_sms), Style.RESET_ALL, Fore.CYAN))
    print(Fore.LIGHTRED_EX+"{/} "+Style.BRIGHT+"by maidens © All rights reserved."+Style.RESET_ALL)
    try:
        menu = int(input(Fore.LIGHTBLUE_EX+ " 1- SMS Yolla\n 2- Çıkış Yap\n\n" + Fore.LIGHTYELLOW_EX + "Seçim: " +Fore.LIGHTGREEN_EX))
    except ValueError:
        system("cls||clear")
